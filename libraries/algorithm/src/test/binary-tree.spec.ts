 ...
 * @LastEditTime : 2024-08-04 16:38:15
 * @LastEditors  : Chen Zhen
 */
import { AdelsonVelskiiLandiTree, BinarySearchTree } from '../index'
...
const isBinarySearchTree = (tree: UnionTree): boolean =>
  tree instanceof BinarySearchTree && !(tree instanceof AdelsonVelskiiLandiTree)
...
describe.each([() => new BinarySearchTree<number>(), () => new AdelsonVelskiiLandiTree<number>()])(
  'BinaryTree - %s',
  (getTree: GetTree) => {
    const tree = getTree()
